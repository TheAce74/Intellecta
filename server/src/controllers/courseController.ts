...
async function generateQuizzesForModules(course: { title: string; modules: { title: string; content: string }[] }) {
...
async function generateQuizForModule(module: { title: string; content: string }) {
